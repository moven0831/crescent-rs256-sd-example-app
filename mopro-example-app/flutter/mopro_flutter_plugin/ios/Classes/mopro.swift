...
public struct AssetBundle {
    public var mainWasm: Data
    public var mainR1cs: Data
    public var groth16Pvk: Data
    public var groth16Vk: Data
    public var proverParams: Data
    public var rangePk: Data
    public var rangeVk: Data
    public var ioLocations: String

    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(mainWasm: Data, mainR1cs: Data, groth16Pvk: Data, groth16Vk: Data, proverParams: Data, rangePk: Data, rangeVk: Data, ioLocations: String) {
        self.mainWasm = mainWasm
        self.mainR1cs = mainR1cs
        self.groth16Pvk = groth16Pvk
        self.groth16Vk = groth16Vk
        self.proverParams = proverParams
        self.rangePk = rangePk
        self.rangeVk = rangeVk
        self.ioLocations = ioLocations
    }
}

#if compiler(>=6)
extension AssetBundle: Sendable {}
#endif


extension AssetBundle: Equatable, Hashable {
    public static func ==(lhs: AssetBundle, rhs: AssetBundle) -> Bool {
        if lhs.mainWasm != rhs.mainWasm {
            return false
        }
        if lhs.mainR1cs != rhs.mainR1cs {
            return false
        }
        if lhs.groth16Pvk != rhs.groth16Pvk {
            return false
        }
        if lhs.groth16Vk != rhs.groth16Vk {
            return false
        }
        if lhs.proverParams != rhs.proverParams {
            return false
        }
        if lhs.rangePk != rhs.rangePk {
            return false
        }
        if lhs.rangeVk != rhs.rangeVk {
            return false
        }
        if lhs.ioLocations != rhs.ioLocations {
            return false
        }
        return true
    }
    ...
    public func hash(into hasher: inout Hasher) {
        hasher.combine(mainWasm)
        hasher.combine(mainR1cs)
        hasher.combine(groth16Pvk)
        hasher.combine(groth16Vk)
        hasher.combine(proverParams)
        hasher.combine(rangePk)
        hasher.combine(rangeVk)
        hasher.combine(ioLocations)
    }
}
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeAssetBundle: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> AssetBundle {
        return
            try AssetBundle(
                mainWasm: FfiConverterData.read(from: &buf), 
                mainR1cs: FfiConverterData.read(from: &buf), 
                groth16Pvk: FfiConverterData.read(from: &buf), 
                groth16Vk: FfiConverterData.read(from: &buf), 
                proverParams: FfiConverterData.read(from: &buf), 
                rangePk: FfiConverterData.read(from: &buf), 
                rangeVk: FfiConverterData.read(from: &buf), 
                ioLocations: FfiConverterString.read(from: &buf)
        )
    }

    public static func write(_ value: AssetBundle, into buf: inout [UInt8]) {
        FfiConverterData.write(value.mainWasm, into: &buf)
        FfiConverterData.write(value.mainR1cs, into: &buf)
        FfiConverterData.write(value.groth16Pvk, into: &buf)
        FfiConverterData.write(value.groth16Vk, into: &buf)
        FfiConverterData.write(value.proverParams, into: &buf)
        FfiConverterData.write(value.rangePk, into: &buf)
        FfiConverterData.write(value.rangeVk, into: &buf)
        FfiConverterString.write(value.ioLocations, into: &buf)
    }
}
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeAssetBundle_lift(_ buf: RustBuffer) throws -> AssetBundle {
    return try FfiConverterTypeAssetBundle.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeAssetBundle_lower(_ value: AssetBundle) -> RustBuffer {
    return FfiConverterTypeAssetBundle.lower(value)
}
...
public enum CrescentError {
    ...
    case ProveError(message: String)
    
    case ShowError(message: String)
    
    case VerifyError(message: String)
...
@_documentation(visibility: private)
#endif
public struct FfiConverterTypeCrescentError: FfiConverterRustBuffer {
    typealias SwiftType = CrescentError

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> CrescentError {
        ...
        case 4: return .SetupError(
            message: try FfiConverterString.read(from: &buf)
        )
        
        case 5: return .CacheError(
            message: try FfiConverterString.read(from: &buf)
        )
    ...
    public static func write(_ value: CrescentError, into buf: inout [UInt8]) {
        switch value {

        

        
        case .ProveError(_ /* message is ignored*/):
            writeInt(&buf, Int32(1))
        case .ShowError(_ /* message is ignored*/):
            writeInt(&buf, Int32(2))
        case .VerifyError(_ /* message is ignored*/):
            writeInt(&buf, Int32(3))
        case .SetupError(_ /* message is ignored*/):
...
@_documentation(visibility: private)
#endif
public func FfiConverterTypeCrescentError_lift(_ buf: RustBuffer) throws -> CrescentError {
    return try FfiConverterTypeCrescentError.lift(buf)
}

#if swift(>=5.8)
@_documentation(visibility: private)
#endif
public func FfiConverterTypeCrescentError_lower(_ value: CrescentError) -> RustBuffer {
    return FfiConverterTypeCrescentError.lower(value)
}


extension CrescentError: Equatable, Hashable {}



extension CrescentError: Foundation.LocalizedError {
    public var errorDescription: String? {
...
public func crescentCleanupCache(cacheId: String)throws   {try rustCallWithError(FfiConverterTypeCrescentError_lift) {
    uniffi_mopro_example_app_fn_func_crescent_cleanup_cache(
...
public func crescentInitializeCache(schemeName: String, assetBundle: AssetBundle)throws  -> String  {
    ...
    uniffi_mopro_example_app_fn_func_crescent_initialize_cache(
        FfiConverterString.lower(schemeName),
        FfiConverterTypeAssetBundle_lower(assetBundle),$0
    )
})
}
public func crescentProve(cacheId: String, jwtToken: String, issuerPem: String, configJson: String, devicePubPem: String?)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeCrescentError_lift) {
    uniffi_mopro_example_app_fn_func_crescent_prove(
        FfiConverterString.lower(cacheId),
        FfiConverterString.lower(jwtToken),
        FfiConverterString.lower(issuerPem),
...
public func crescentShow(cacheId: String, clientStateB64: String, proofSpecJson: String, presentationMessage: String?, devicePrvPem: String?)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeCrescentError_lift) {
    uniffi_mopro_example_app_fn_func_crescent_show(
        FfiConverterString.lower(cacheId),
        FfiConverterString.lower(clientStateB64),
        FfiConverterString.lower(proofSpecJson),
        FfiConverterOptionString.lower(presentationMessage),
        FfiConverterOptionString.lower(devicePrvPem),$0
    )
})
}
public func crescentVerify(cacheId: String, showProofB64: String, proofSpecJson: String, presentationMessage: String?, issuerPem: String, configJson: String)throws  -> String  {
    return try  FfiConverterString.lift(try rustCallWithError(FfiConverterTypeCrescentError_lift) {
    uniffi_mopro_example_app_fn_func_crescent_verify(
        FfiConverterString.lower(cacheId),
        FfiConverterString.lower(showProofB64),
        FfiConverterString.lower(proofSpecJson),
        FfiConverterOptionString.lower(presentationMessage),
        FfiConverterString.lower(issuerPem),
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_mopro_example_app_checksum_func_crescent_verify() != 14356) {
        return InitializationResult.apiChecksumMismatch
    }
