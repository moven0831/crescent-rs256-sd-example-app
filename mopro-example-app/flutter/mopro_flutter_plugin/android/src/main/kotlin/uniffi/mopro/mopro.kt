...
internal interface IntegrityCheckingUniffiLib : Library {
    ...
    fun uniffi_mopro_example_app_checksum_func_crescent_verify(): Short
...
internal interface UniffiLib : Library {
    ...
    // FFI functions
    fun uniffi_mopro_example_app_fn_func_crescent_cleanup_cache(
    ...
    fun uniffi_mopro_example_app_fn_func_crescent_prove(
        `cacheId`: RustBuffer.ByValue,
        `jwtToken`: RustBuffer.ByValue,
        `issuerPem`: RustBuffer.ByValue,
    ...
    fun uniffi_mopro_example_app_fn_func_crescent_show(
        `cacheId`: RustBuffer.ByValue,
        `clientStateB64`: RustBuffer.ByValue,
        `proofSpecJson`: RustBuffer.ByValue,
        `presentationMessage`: RustBuffer.ByValue,
        `devicePrvPem`: RustBuffer.ByValue,
        uniffi_out_err: UniffiRustCallStatus,
    ): RustBuffer.ByValue

    fun uniffi_mopro_example_app_fn_func_crescent_verify(
        `cacheId`: RustBuffer.ByValue,
        `showProofB64`: RustBuffer.ByValue,
        `proofSpecJson`: RustBuffer.ByValue,
        `presentationMessage`: RustBuffer.ByValue,
        `issuerPem`: RustBuffer.ByValue,
        `configJson`: RustBuffer.ByValue,
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_mopro_example_app_checksum_func_crescent_verify() != 14356.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
data class AssetBundle(
    var `mainWasm`: kotlin.ByteArray,
    var `mainR1cs`: kotlin.ByteArray,
    var `groth16Pvk`: kotlin.ByteArray,
    var `groth16Vk`: kotlin.ByteArray,
    var `proverParams`: kotlin.ByteArray,
    var `rangePk`: kotlin.ByteArray,
    var `rangeVk`: kotlin.ByteArray,
    var `ioLocations`: kotlin.String,
) {
    companion object
}
 ...
 * @suppress
 */
public object FfiConverterTypeAssetBundle : FfiConverterRustBuffer<AssetBundle> {
    override fun read(buf: ByteBuffer): AssetBundle =
        AssetBundle(
    ...
    override fun allocationSize(value: AssetBundle) =
        (
            FfiConverterByteArray.allocationSize(value.`mainWasm`) +
                FfiConverterByteArray.allocationSize(value.`mainR1cs`) +
                FfiConverterByteArray.allocationSize(value.`groth16Pvk`) +
                FfiConverterByteArray.allocationSize(value.`groth16Vk`) +
                FfiConverterByteArray.allocationSize(value.`proverParams`) +
                FfiConverterByteArray.allocationSize(value.`rangePk`) +
                FfiConverterByteArray.allocationSize(value.`rangeVk`) +
                FfiConverterString.allocationSize(value.`ioLocations`)
        )
    ...
    override fun write(
        ...
        FfiConverterByteArray.write(value.`mainWasm`, buf)
        FfiConverterByteArray.write(value.`mainR1cs`, buf)
        FfiConverterByteArray.write(value.`groth16Pvk`, buf)
        FfiConverterByteArray.write(value.`groth16Vk`, buf)
        FfiConverterByteArray.write(value.`proverParams`, buf)
        FfiConverterByteArray.write(value.`rangePk`, buf)
        FfiConverterByteArray.write(value.`rangeVk`, buf)
        FfiConverterString.write(value.`ioLocations`, buf)
    }
}
...
sealed class CrescentException(
    ...
    companion object ErrorHandler : UniffiRustCallStatusErrorHandler<CrescentException> {
        override fun lift(error_buf: RustBuffer.ByValue): CrescentException = FfiConverterTypeCrescentError.lift(error_buf)
    }
}
 ...
 * @suppress
 */
public object FfiConverterTypeCrescentError : FfiConverterRustBuffer<CrescentException> {
    override fun read(buf: ByteBuffer): CrescentException =
        when (buf.getInt()) {
            1 -> CrescentException.ProveException(FfiConverterString.read(buf))
            2 -> CrescentException.ShowException(FfiConverterString.read(buf))
            3 -> CrescentException.VerifyException(FfiConverterString.read(buf))
            4 -> CrescentException.SetupException(FfiConverterString.read(buf))
            5 -> CrescentException.CacheException(FfiConverterString.read(buf))
            else -> throw RuntimeException("invalid error enum value, something is very wrong!!")
        }

    override fun allocationSize(value: CrescentException): ULong = 4UL

    override fun write(
        value: CrescentException,
        buf: ByteBuffer,
    ) {
        when (value) {
            is CrescentException.ProveException -> {
                buf.putInt(1)
                Unit
            }
            is CrescentException.ShowException -> {
                buf.putInt(2)
                Unit
            }
            is CrescentException.VerifyException -> {
                buf.putInt(3)
                Unit
            }
            is CrescentException.SetupException -> {
                buf.putInt(4)
                Unit
            }
            is CrescentException.CacheException -> {
                buf.putInt(5)
                Unit
            }
...
fun `crescentCleanupCache`(`cacheId`: kotlin.String) =
...
fun `crescentInitializeCache`(
    ...
    FfiConverterString.lift(
        uniffiRustCallWithError(CrescentException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_example_app_fn_func_crescent_initialize_cache(
                FfiConverterString.lower(`schemeName`),
                FfiConverterTypeAssetBundle.lower(`assetBundle`),
                _status,
            )
        },
    )
...
fun `crescentProve`(
    ...
    `issuerPem`: kotlin.String,
    `configJson`: kotlin.String,
    `devicePubPem`: kotlin.String?,
): kotlin.String =
    FfiConverterString.lift(
        uniffiRustCallWithError(CrescentException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_example_app_fn_func_crescent_prove(
                ...
                FfiConverterOptionalString.lower(`devicePubPem`),
                _status,
            )
        },
    )
...
fun `crescentShow`(
    `cacheId`: kotlin.String,
    `clientStateB64`: kotlin.String,
    `proofSpecJson`: kotlin.String,
    `presentationMessage`: kotlin.String?,
    `devicePrvPem`: kotlin.String?,
): kotlin.String =
    FfiConverterString.lift(
        uniffiRustCallWithError(CrescentException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_example_app_fn_func_crescent_show(
                FfiConverterString.lower(`cacheId`),
                FfiConverterString.lower(`clientStateB64`),
                FfiConverterString.lower(`proofSpecJson`),
                FfiConverterOptionalString.lower(`presentationMessage`),
                FfiConverterOptionalString.lower(`devicePrvPem`),
                _status,
            )
        },
    )
...
fun `crescentVerify`(
    ...
    FfiConverterString.lift(
        uniffiRustCallWithError(CrescentException) { _status ->
            UniffiLib.INSTANCE.uniffi_mopro_example_app_fn_func_crescent_verify(
                FfiConverterString.lower(`cacheId`),
