...
*FORKED on 8/2/2024*  This is a fork of the ark poly commit repo which implements kzg10, as the open function was pub(crate) in the original repo.
Downloaded: `wget https://crates.io/api/v1/crates/ark-poly-commit/0.4.0/download`
